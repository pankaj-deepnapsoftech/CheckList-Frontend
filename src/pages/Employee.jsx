...
const  Employee=()=>{
  ...
  const { getAllEmployee, employeeQuery, searchEmployee, toggleTerminateEmployee } =
    RegisterEmployee({
      search: value,
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-3">
          ...
          <div className="flex gap-3 w-full sm:w-auto">
            ...
            >
              ...
              {employees.map((emp) => (
                <option
                  key={emp.employee_company._id}
                  value={emp.employee_company._id}
                >
                  {emp.employee_company.company_name}
                </option>
              ))}
            </select>
            ...
            >
              ...
              {employees.map((emp) => (
                <option
                  key={emp.employee_plant._id}
                  value={emp.employee_plant._id}
                >
                  {emp.employee_plant.plant_name}
                </option>
              ))}
            </select>
          </div>
